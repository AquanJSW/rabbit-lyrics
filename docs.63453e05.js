...
function parseLyrics(source) {
  ...
  for (var i = 0; i < lines.length; i++) {
    ...
    var endMatch = line.match(endRegex);
 ...
 */
var RabbitLyrics = /** @class */function () {
  function RabbitLyrics( /** Lyrics container element. Support data-* attributes for options. */
  lyricsElement, /** Audio or video element. Note: embeded media elements in <iframe> are not supported. */
  mediaElement, /** Lyrics options. */
  options) {
    var _this = this;
...
//# sourceMappingURL=docs.63453e05.js.map